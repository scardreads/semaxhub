...
<th className="border-b border-border px-3 py-2 font-semibold">Interim bucket</th>
<th className="border-b border-border px-3 py-2 font-semibold">What visitors should take away</th>
</tr></thead><tbody>
<tr>
<td className="border-b border-border px-3 py-2 align-top">Category 1</td>
<td className="border-b border-border px-3 py-2 align-top">Nominated substances under evaluation; FDA has described a different interim enforcement posture for this bucket than for Category 2</td>
</tr>
<tr>
<td className="border-b border-border px-3 py-2 align-top">Category 2</td>
<td className="border-b border-border px-3 py-2 align-top">Nominated substances FDA has associated with <strong>significant safety concerns</strong> in its interim framework</td>
</tr>
<tr>
<td className="border-b border-border px-3 py-2 align-top">Category 3</td>
<td className="border-b border-border px-3 py-2 align-top">Nominations FDA treats as inadequately supported</td>
</tr>
</tbody></table></div>
