...
Brain growth-factor pathway follow-ons (BDNF/TrkB, monoamines, gene networks) are covered on **[How it may work](/how-it-may-work)**. Companion peptide **Selank** (tuftsin + PGP) came from the same design school: **[Semax vs Selank](/semax-vs-selank)**.
